...
![My helpful screenshot]({{ site.url }}/assets/raspi_config.png)
...
<img src="Week1/RPIsetup/advance_opt.png" alt="screen" style="width: 400px;">
...
<img src="Week1/RPIsetup/Pi-installer-menu.png" alt="menu1" style="width: 300px;"/>
...
<img src="Week1/RPIsetup/Pi-installer-menu-02.png" alt="menu2" style="width: 300px;"/>

Enter **1** for SSH.

* Next, we accept the default port (**y**).

<img src="Week1/RPIsetup/Pi-installer-menu-03.png" alt="menu3" style="width: 300px;"/>
...
<img src="Week1/RPIsetup/Pi-installer-menu-04.png" alt="menu4" style="width: 300px;"/>

You will now return to the main menu, where you can see your Weaved Service Connection installed, then enter **3** to exit.

<img src="Week1/RPIsetup/Pi-installer-menu-051.png" alt="menu5" style="width: 300px;"/>
...
<img src="Week1/RPIsetup/weaved_connected.png" alt="weaved" style="width: 400px;"/>
...
<img src="Week1/RPIsetup/weaved_ssh.png" alt="weaved" style="width: 400px;"/>
...
<img src="Week1/RPIsetup/Putty.JPG" alt="weaved" style="width: 400px;"/>

Once downloaded, double click on the **putty.exe** and you will see the window looks like below:

<img src="Week1/RPIsetup/PuttyConnect.JPG" alt="weaved" style="width: 400px;"/>
...
<img src="Week1/RPIsetup/Screen_terminal.png" alt="screen1" style="width: 400px;"/>
...
<img src="Week1/RPIsetup/Screen_new_attached.png" alt="screen2" style="width: 400px;"/>
...
<img src="Week1/RPIsetup/Screen_list.png" alt="screen3" style="width: 400px;"/>

* We get the list and the screen ID. If we want to attach to a particular *screen*:

<img src="Week1/RPIsetup/Screen_attaching.png" alt="screen4" style="width: 400px;"/>
