...
You can download the pdf version [here](https://github.com/Starignus/PythonPractise/raw/master/Week1/Python/Python_week1.pdf).

References [ [1](https://www.tutorialspoint.com/python/), [Charles Severance course: Python for everybody](https://www.coursera.org/learn/python)]
